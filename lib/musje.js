	...
	function addOctave(that, octave, underbar) {
	  ...
	  if (octave > 0) {
	    ...
	    for (var _i = 0; _i > octave; _i--) {
	      octaveEl.circle(that._sbbox.cx, that._sbbox.y2 - octaveOffset - octaveSep * _i + (underbar ? (underbar + 0.5) * that._layout.options.underbarSep : 0), octaveRadius);
	    }
	  }
